...
const PROJECT_FEATURES_LIST = {
  ...
  template: {
    ...
    description:
      "Mark this project as a workspace-canonical template. Templates are hidden from the main project list and appear in the sidebar Templates group, where any workspace member can clone them in one click.",
    icon: <Copy className="h-5 w-5 flex-shrink-0 text-tertiary" />,
    isPro: false,
    isEnabled: true,
  },
};
