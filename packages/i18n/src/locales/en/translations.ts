...
export default {
  ...
  language: "Language",
  activity_commented: "Commented {time}",
  ...
  join_project_modal: {
    ...
    button: "Join Project",
    joining: "Joining...",
    prompt_prefix: "Are you sure you want to join the project",
    prompt_suffix: "? Please click the 'Join Project' button below to continue.",
  },
  leave_project_modal: {
    title: "Leave Project",
    leaving: "Leaving...",
    warning_prefix: "Are you sure you want to leave the project -",
    warning_suffix: "? All of the work items associated with you will become inaccessible.",
    name_prompt_prefix: "Enter the project name",
    name_prompt_suffix: " to continue:",
  ...
  publish_project: {
    ...
    updating: "Updating",
    live_on_web: "This project is now live on web",
    views: "Views",
    allow_comments: "Allow comments",
    allow_reactions: "Allow reactions",
    allow_voting: "Allow voting",
    anyone_can_access: "Anyone with the link can access",
    toast: {
      update_success: "Publish settings updated successfully!",
  ...
  onboarding: {
    ...
    team: {
      ...
      description: "Work in Tick happens best with your team. Invite them now to use Tick to its potential.",
      add_another: "Add another",
      do_it_later: "I’ll do it later",
    },
    role: {
      title: "What's your role?",
      description: "Let's set up Tick for how you work.",
      select_one: "Select one",
      success_message: "Profile setup completed!",
      error_message: "Profile setup failed. Please try again!",
  ...
  archive_restore_modal: {
    ...
    archive_success_message: "{name} has been archived successfully",
    archive_error_message: "Project could not be archived. Please try again.",
    restore_success_title: "Restore success",
    restore_success_message: "You can find {name} in your projects.",
  ...
  delete_project_modal: {
    ...
    warning_prefix: "Are you sure you want to delete project",
    warning_suffix:
  ...
  profile_form: {
    ...
    cover_process_failed: "Failed to process cover image",
    updating: "Updating...",
  ...
  use_template_subtitle:
    "Create a new project from this template — every work item, cycle, module and custom field is cloned.",
  template_start_date: "Start date",
  template_start_date_hint: "The template's timeline shifts to start on this date, keeping its overall span.",
  create_from_template: "Create project",
  ...
  issue_activity: {
    common: {
      ...
      from: "from",
      of: "of",
      work_items_fallback: "Work items",
      issue_deleted_tooltip: "This work item has been deleted",
      bot_suffix: "Bot",
    },
    archived: "archived the work item",
    restored: "restored the work item",
    assignee_added: "added a new assignee",
    assignee_removed: "removed the assignee",
    attachment_uploaded: "uploaded a new attachment",
    attachment_removed: "removed an attachment",
    cycle_added: "added this work item to the cycle",
    cycle_set: "set the cycle to",
    cycle_removed: "removed the work item from the cycle",
    created_via: "created the work item via",
    created: "created the work item.",
    deleted: "deleted a work item.",
    description_updated: "updated the description",
    estimate_set: "set the estimate point to",
    estimate_removed: "removed the estimate point",
    inbox_declined: "declined this work item from intake.",
    inbox_snoozed: "snoozed this work item.",
    inbox_accepted: "accepted this work item from intake.",
    inbox_declined_duplicate: "declined this work item from intake by marking a duplicate work item.",
    inbox_updated_status: "updated intake work item status.",
    label_added: "added a new label",
    label_removed: "removed the label",
    link_added: "added",
    link_updated: "updated the",
    link_removed: "removed this",
    link_noun: "link",
    module_added: "added this work item to the module",
    module_set: "set the module to",
    module_removed: "removed the work item from the module",
    name_set: "set the name to",
    parent_set: "set the parent to",
    parent_removed: "removed the parent",
    priority_set: "set the priority to",
    start_date_set: "set the start date to",
    start_date_removed: "removed the start date",
    state_set: "set the state to",
    target_date_set: "set the due date to",
    target_date_removed: "removed the due date",
  },
  lark_quick_create: {
